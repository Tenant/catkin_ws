...
if("TRUE" STREQUAL "TRUE")
  set(novatel_msgs_SOURCE_PREFIX /home/sukie/catkin_ws/src/novatel_span_driver/novatel_msgs)
  set(novatel_msgs_DEVEL_PREFIX /home/sukie/catkin_ws/devel)
  ...
  set(novatel_msgs_INSTALL_PREFIX /home/sukie/catkin_ws/install)
...
if(NOT "/home/sukie/catkin_ws/devel/include " STREQUAL " ")
  set(novatel_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/sukie/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'novatel_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'novatel_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sukie/catkin_ws/src/novatel_span_driver/novatel_msgs/${idir}'.  ${_report}")
    endif()
...
set(novatel_msgs_EXPORTED_TARGETS "novatel_msgs_generate_messages_cpp;novatel_msgs_generate_messages_eus;novatel_msgs_generate_messages_lisp;novatel_msgs_generate_messages_nodejs;novatel_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${novatel_msgs_dep}_FOUND)
      find_package(${novatel_msgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${novatel_msgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
