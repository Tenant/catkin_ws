...
struct INSPVAX_
{
  ...
  enum {
    INS_STATUS_INACTIVE = 0u,
    INS_STATUS_ALIGNING = 1u,
    INS_STATUS_HIGH_VARIANCE = 2u,
    INS_STATUS_SOLUTION_GOOD = 3u,
    INS_STATUS_SOLUTION_FREE = 6u,
    INS_STATUS_ALIGNMENT_COMPLETE = 7u,
    INS_STATUS_DETERMINING_ORIENTATION = 8u,
    INS_STATUS_WAITING_INITIALPOS = 9u,
    POSITION_TYPE_NONE = 0u,
    POSITION_TYPE_SBAS = 52u,
    POSITION_TYPE_PSEUDORANGE_SINGLE_POINT = 53u,
    POSITION_TYPE_PSEUDORANGE_DIFFERENTIAL = 54u,
    POSITION_TYPE_RTK_FLOAT = 55u,
    POSITION_TYPE_RTK_FIXED = 56u,
    POSITION_TYPE_OMNISTAR = 57u,
    POSITION_TYPE_OMNISTAR_HP = 58u,
    POSITION_TYPE_OMNISTAR_XP = 59u,
    POSITION_TYPE_PPP_CONVERGING = 73u,
    POSITION_TYPE_PPP = 74u,
    EXTENDED_STATUS_POSITION_UPDATE_APPLIED = 1u,
    EXTENDED_STATUS_PHASE_UPDATE_APPLIED = 2u,
    EXTENDED_STATUS_ZUPT_APPLIED = 4u,
    EXTENDED_STATUS_WHEEL_SENSOR_APPLIED = 8u,
    EXTENDED_STATUS_HEADING_UPDATE_APPLIED = 16u,
    EXTENDED_STATUS_INS_SOLUTION_CONVERGED = 64u,
  };
